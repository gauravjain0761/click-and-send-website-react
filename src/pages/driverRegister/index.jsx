                            ...
                            <div className="bg-light rounded p-5">
                                <form className="" method="" action="" id="">
                                    <div className="input-group">
                                        <div className="row">
                                            <div className="col-6">
                                                <label className="radiocontainer">Driver
                                                    <input type="radio" checked="checked" name="radio" id="user_type_driver" />
                                                        <span className="checkmark"></span>
                                                </label>
                                            </div>
                                            <div className="col-6">
                                                <label className="radiocontainer">Company
                                                    <input type="radio" name="radio" id="user_type_company" />
                                                        <span className="checkmark"></span>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div className="text-center mt-5">
                                        ...
                                        className=" btn btn-orange text-light btn-blockz btn-block"><i className="fas fa-user"></i> &nbsp; Become a Customer</button>
                                    </div>
                                </form>
                            </div>
                        </div>
